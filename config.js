...
const CONFIG = {
  ...
  gallery: [
    { img: "", cat: "landing",   size: "tall", caption: "Проект 1" },
    { img: "", cat: "shop",      size: "",     caption: "Проект 2" },
    { img: "", cat: "portfolio", size: "",     caption: "Проект 3" },
    { img: "", cat: "landing",   size: "",     caption: "Проект 4" },
    { img: "", cat: "shop",      size: "wide", caption: "Проект 5" },
    { img: "", cat: "portfolio", size: "",     caption: "Проект 6" },
    { img: "", cat: "landing",   size: "",     caption: "Проект 7" },
    { img: "", cat: "shop",      size: "tall", caption: "Проект 8" },
  ],
